...
uint256 hashGenesisBlock("0xed64e895462fe7d50d6105b40913cda3223300de2ca73bd4fc3452142be48523");
...
const string strMessageMagic = "UniteCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // UniteCoin: 2 days
static const int64 nTargetSpacing = 120; // UniteCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal unitecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UniteCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Thanksgiving, 2013";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1385675206; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3199441;
        ...
        assert(block.hashMerkleRoot == uint256("0xa7360a9a1883a7bbc3fc3c4b91b6eca83ecb1ab705a44407de1c669f76b67542"));
